      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: `Contoh Kiraan Refinance Rumah Malaysia ${currentYear}`,
            description: `Lihat contoh kiraan refinance rumah dengan penjimatan sebenar. Ketahui berapa anda boleh jimat dengan refinance ${currentYear}.`,
